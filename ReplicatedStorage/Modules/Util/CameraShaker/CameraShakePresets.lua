...
local CameraShakePresets = {
	...
	Bump3 = function()
		local c = CameraShakeInstance.new(5, 5, 0, 1.5)
		c.PositionInfluence = Vector3.new(0.25, 0.25, 0.25)
		c.RotationInfluence = Vector3.new(3, 3, 3)
		return c
	end;
	...
	-- Sustained.
	Softquake = function()
		local c = CameraShakeInstance.new(0.6/2, 3.5/2, 2/2, 10/2)
		c.PositionInfluence = Vector3.new(0.25, 0.25, 0.25)
		c.RotationInfluence = Vector3.new(1, 1, 2.5)
		return c
	end;
