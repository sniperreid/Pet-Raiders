...
function Module:Create(EggName, EggAmount, Grid, ...)
	local TemplateExists = Grid and Grid:FindFirstChild(EggName)
	...
	local _EggIcon = Content.EggIcon
	...
	_Amount.Text = ("x%s"):format(Short:AddSuffix(EggAmount))
	
	_EggIcon.Image = ImageModule(EggName)
